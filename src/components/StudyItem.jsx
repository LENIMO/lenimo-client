  ...
  return (
    <div className={styles.StudyItem}>
      <div className={styles.longInfo}>
        ...
        <div className={styles.fw400}>{data.profiles.position}</div>
      </div>
      <img
        height='50'
        width='50'
      ...
      />
      <div style={{ fontWeight: 700 }} className={styles.middleInfo}>
      ...
      <div className={(styles.verticalInfo, styles.shortInfo)}>
        ...
        <p className={styles.fw400}>목표 시간</p>
      </div>
      <div className={(styles.verticalInfo, styles.shortInfo)}>
        <p className={styles.fw700} style={{ color: '#FF7F7F  ' }}>
          {data.study_time}
        </p>
        <p className={styles.fw400}>공부 시간</p>
      </div>
      <div className={(styles.verticalInfo, styles.shortInfo)}>
        <p
